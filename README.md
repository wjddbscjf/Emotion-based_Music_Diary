...
<img src="images/플로우차트.png" width=100%>


##  Core Features

-  **일기 작성 기능** – 사용자가 자유롭게 일기를 작성할 수 있음  
...
| **Database (optional)** | JSON-based local DB |
| **API** | openAI / YouTube Search API/ Spotify API |
| **Version Control** | GitHub, Git |
| **Deployment** | GitHub Pages / SSH 
...
| **Week 6 (Final)** | 12/02 ~ 12/16 | 완성본 제출 및 최종 점검 |
